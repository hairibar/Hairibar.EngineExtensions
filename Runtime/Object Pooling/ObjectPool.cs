...
namespace Hairibar.EngineExtensions.Pooling
{
    [AddComponentMenu("")]
    public sealed class ObjectPool : MonoBehaviour
    {
        ...
        readonly static List<GameObject> tempList = new List<GameObject>();

        readonly Dictionary<GameObject, List<GameObject>> pooledObjects = new Dictionary<GameObject, List<GameObject>>();
        readonly Dictionary<GameObject, GameObject> spawnedObjects = new Dictionary<GameObject, GameObject>();
        ...
        public static GameObject Spawn(GameObject prefab, Transform parent, Vector3 position, Quaternion rotation)
        {
            ...
            {
                CreatePool(prefab, DEFAULT_POOL_SIZE);
